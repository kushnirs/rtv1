...
// inline void  dblSort3( double *a, double *b, double *c) // make: a <= b <= c
// {
// 	if( a > b )
// 		SWAP(a,b);	// now a<=b
// 	if( c < b )
...
// 	int res3 = SolveP3( x, 2.0 * b, b * b - 4.0 * d, -c * c);
...
// {
// 	double fxs= ((4.0 * x + 3.0 * a) * x + 2.0 * b) * x + c;
// 	if (fxs == 0.0)
// 		return (x);
...
// inline int   SolveP4(double *x, double a, double b, double c, double d)
// {
