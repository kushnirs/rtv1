...
/*   Updated: 2018/02/28 12:54:32 by sergee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rtv1_cl.h"

static int	check_float(char *str, float *res)
{
	int		i;
	int		len;
	float	num;
...
static int	check_coord(char *str, t_point *res)
{
	int		i;
	float	num;
...
static int	check_int(char *str, int *res)
{
	int		i;
	int		len;
	float	num;
